/*
  ...
  Version with the reduced enumeration and detection of non-halting machines to make 
  the sample of D5. The output is the distribution of runtime of halting machines. 
...
int main(int argn, char* argv[]) {
  ...
  // Prints the results
  for( map<int,unsigned long long>::iterator ii=results.begin(); ii!=results.end(); ++ii)
    {
